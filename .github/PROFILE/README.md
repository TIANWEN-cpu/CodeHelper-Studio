<p align="center">
  <img src="../../resources/icons/icon.png" alt="CodeHelper Logo" width="100">
</p>

<h1 align="center">Hi, I'm CodeHelper :wave:</h1>

<h3 align="center">AI 驱动的一体化桌面编程学习平台</h3>

<p align="center">
  集代码编辑、AI 对话、智能刷题、知识库检索与错题追踪于一身。<br>
  写代码、问 AI、刷题、查资料 -- 全在一个窗口里完成。
</p>
...
<table>
  <tr>
    <td>
      <h4>:pencil2: Monaco 代码编辑器</h4>
      <p>VSCode 同款编辑引擎，语法高亮、智能补全、多标签页、内置控制台</p>
    </td>
    <td>
      <h4>:robot: AI 智能对话</h4>
      <p>流式输出、Markdown 渲染、预设提示词、长期记忆、多模型支持</p>
    </td>
  </tr>
  <tr>
    <td>
      <h4>:dart: 题库系统</h4>
      <p>158+ 题目，力扣/牛客/PAT/CSP/数学建模，自动判题，六语言支持</p>
    </td>
    <td>
      <h4>:books: 知识库 RAG</h4>
      <p>本地文档导入与检索，支持 PDF/Markdown/TXT，关键词匹配排序</p>
    </td>
  </tr>
  <tr>
    <td>
      <h4>:warning: 错题本</h4>
      <p>自动收集错题，追踪错误类型，AI 分析薄弱知识点，一键重做</p>
    </td>
    <td>
      <h4>:zap: 代码运行器</h4>
      <p>Python/C/C++/C#/JavaScript/SQL 六语言本地执行，资源限制保护</p>
    </td>
  </tr>
</table>
...
<p>
  ...
  <img src="https://img.shields.io/badge/Monaco-0.55-007ACC?logo=visual-studio-code&logoColor=white" alt="Monaco">
...
<p align="center">
  <sub>Built with :heart: using Electron + React + TypeScript</sub>
</p>
